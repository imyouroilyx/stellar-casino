...
const ANIMALS = [
  ...
  { id: 'WITCH',     label: 'พ่อมดแม่มด',   icon: '🧙', color: 'bg-gradient-to-br from-green-900/60  to-black border-green-500/50  hover:border-green-400',  shadow: 'rgba(34,197,94,0.5)'  },
]
