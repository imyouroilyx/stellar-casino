      ...
      <div className="flex flex-col items-center gap-8 p-6 max-w-md w-full">
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          <Link href="/games/kaeng"
            className="group p-5 rounded-2xl border border-yellow-500/30 bg-gradient-to-br from-yellow-900/20 to-black/60 hover:border-yellow-400/50 hover:from-yellow-900/30 transition-all">
            <div className="flex items-center gap-4">
              <span className="text-4xl">🤖</span>
              <div className="flex-1">
                <p className="text-xl font-black text-yellow-400 uppercase">Single Player</p>
                <p className="text-gray-500 text-sm font-bold">เล่นคนเดียวกับ AI เจ้ามือ</p>
              </div>
          ...
          <Link href="/games/kaeng/multiplayer"
            className="group p-5 rounded-2xl border border-purple-500/30 bg-gradient-to-br from-purple-900/20 to-black/60 hover:border-purple-400/50 hover:from-purple-900/30 transition-all">
            <div className="flex items-center gap-4">
              <span className="text-4xl">🏆</span>
              <div className="flex-1">
                <p className="text-xl font-black text-purple-400 uppercase">Multiplayer</p>
                <p className="text-gray-500 text-sm font-bold">ทุกคนวัดกันเอง ไม่มีเจ้ามือ</p>
              </div>
              <span className="text-purple-500/50 text-2xl group-hover:translate-x-1 transition-transform">→</span>
            </div>
            <div className="mt-2 flex gap-2">
              <span className="text-[10px] bg-purple-500/20 text-purple-300 px-2 py-0.5 rounded-full font-bold border border-purple-500/20">Tournament</span>
              <span className="text-[10px] bg-green-500/20 text-green-300 px-2 py-0.5 rounded-full font-bold border border-green-500/20">สูงสุด 6 คน</span>
            </div>
          </Link>
        </div>
